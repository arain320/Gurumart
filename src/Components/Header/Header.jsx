          ...
          <div className="w-full bg-white z-[5]">
            <div className="w-full flex justify-between items-center px-8 py-2 relative">
              ...
              <ul
                className={
                  !open4
                    ? "flex items-center gap-4 max-[800px]:absolute max-[800px]:top-[100px] max-[800px]:left-5 max-[800px]:w-full max-[800px]:flex-col max-[800px]:opacity-0"
                    : "flex items-center gap-4 max-[800px]:absolute max-[800px]:top-[100px] max-[800px]:left-5 max-[800px]:w-full max-[800px]:flex-col max-[800px]:opacity-[1]"
                }
              >
                <li
              ...
              {open3 ? (
                <div className="absolute top-[80px] left-[250px] w-[800px] bg-white shadow-lg z-[3] max-[800px]:top-[300px] max-[800px]:left-[10px] max-[800px]:w-full max-[1070px]:left-[20px]">
